sap.ui.define([
    ...
    return BaseObject.extend("a2a.portal.services.NotificationService", {
         ...
         * @returns {sap.ui.model.json.JSONModel} The notification model
         */
        getModel: function () {
        ...
        loadNotifications: function (bReset) {
            var that = this;
            var oModel = this._notificationModel;
            ...
            var sUrl = "/api/notifications?" + aParams.join("&");
            ...
            return new Promise(function (resolve, reject) {
                jQuery.ajax({
                    ...
                    success: function (oResponse) {
                        var aNewNotifications = oResponse.notifications || [];
        ...
        loadMoreNotifications: function () {
            var oData = this._notificationModel.getData();
            ...
            return new Promise(function (resolve, reject) {
                jQuery.ajax({
                    ...
                    success: function (oResponse) {
                        ...
                        var oData = oModel.getData();
                        var oNotification = oData.notifications.find(function (n) {
            ...
            return new Promise(function (resolve, reject) {
                jQuery.ajax({
                    ...
                    success: function (oResponse) {
                        ...
                        oData.notifications.forEach(function (oNotification) {
                            if (oNotification.status === "unread") {
                                oNotification.status = "read";
            ...
            return new Promise(function (resolve, reject) {
                jQuery.ajax({
                    ...
                    success: function (oResponse) {
                        ...
                        var oData = oModel.getData();
                        var iIndex = oData.notifications.findIndex(function (n) {
                            return n.id === sNotificationId;
                        });
                        
                        if (iIndex >= 0) {
                            var oNotification = oData.notifications[iIndex];
        ...
        _startAutoRefresh: function () {
            ...
            this._refreshInterval = setInterval(function () {
                ...
                var oData = that._notificationModel.getData();
                if (oData.currentOffset === 0) {
                    that.loadNotifications(true);
                }
            }, 300000); // 5 minutes
        },
