...
from app.a2a.agents.agent1_standardization.active.data_standardization_agent_sdk import DataStandardizationAgentSDK
...
from app.a2a.agents.agent4_calc_validation.active.calc_validation_agent_sdk import CalcValidationAgentSDK
...
class BDCSmartContractIntegrator:
    ...
    async def deploy_contracts(self) -> Dict[str, str]:
        ...
        try:
            ...
            compile_result = os.system("forge build")
            if compile_result != 0:
            ...
            deploy_result = os.system("forge script script/DeployBDCA2A.s.sol:DeployBDCA2A --rpc-url http://localhost:8545 --broadcast --private-key 0xac0974bec39a17e36ba4a6b4d238ff944bacb478cbed5efcae784d7bf4f2ff80")
