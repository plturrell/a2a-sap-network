            ...
            test_cases = [
                {
                    ...
                    "module": "app.a2a.agents.data_standardization_agent",
                ...
                },
                {
                    ...
                    "module": "app.a2a.agents.data_manager_agent",
                ...
                },
                {
                    ...
                    "module": "app.a2a.agents.agent_manager_agent", 
                ...
                },
                {
                    ...
                    "module": "app.a2a.agents.vector_processing_agent",
    ...
    async def test_data_manager_self_reference_logging(self, mock_http_client):
        ...
        with patch('app.a2a.core.ai_decision_logger_database.httpx.AsyncClient') as mock_client_class:
            ...
            decision_id = await agent.ai_decision_logger.log_decision(
                ...
                question="Should I store this data in HANA or Supabase?",
