...
class AdvancedAIEnhancer:
    ...
    async def _apply_grok_enhancements(self, ord_document: ORDDocument, ai_response: str) -> Dict[str, Any]:
        ...
        try:
            ...
            print(f"DEBUG: Found {len(suggested_apis)} suggested API resources")
            ...
            if suggested_apis:
                ...
                for api_resource in suggested_apis:
                    try:
                        print(f"DEBUG: Processing API resource: {api_resource.get('title')} with ordId: {api_resource.get('ordId')}")
                        ...
                        print(f"DEBUG: About to call validation method")
