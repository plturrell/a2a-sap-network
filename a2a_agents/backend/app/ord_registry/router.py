...
ord_registry = ORDRegistryService(base_url="http://localhost:8000/api/v1/ord")
            ...
            try:
                ...
                if validation_result.errors:
                    ...
                    if registry.storage:
                        ...
                        if not registry.storage.hana_client and not registry.storage.supabase_client:
...
async def update_ord_document(registration_id: str, ord_document: ORDDocument):
