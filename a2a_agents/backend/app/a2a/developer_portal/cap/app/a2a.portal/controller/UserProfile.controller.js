sap.ui.define([
    ...
    return Controller.extend("a2a.portal.controller.UserProfile", {
        ...
        _initializeUserProfile: function () {
            ...
            var oUserInfo = this._getUserInfoFromToken();
        ...
        _getUserInfoFromToken: function () {
            try {
                ...
                var sToken = this._getJWTToken();
                
                if (sToken) {
                    var oDecodedToken = this._decodeJWT(sToken);
        ...
        _loadUserSessions: function () {
            ...
            jQuery.ajax({
                ...
                success: function (oData) {
                    var oUserModel = that.getView().getModel("user");
        ...
        onTerminateSession: function (oEvent) {
            var that = this;
            var sSessionId = oEvent.getSource().data("sessionId");
        ...
        onSavePreferences: function () {
            ...
            var oPreferences = oUserModel.getProperty("/preferences");
        ...
        onChangePasswordConfirm: function () {
            var oDialog = this._oChangePasswordDialog;
            var sCurrentPassword = oDialog.getContent()[0].getItems()[1].getValue();
            var sNewPassword = oDialog.getContent()[0].getItems()[3].getValue();
            var sConfirmPassword = oDialog.getContent()[0].getItems()[5].getValue();
        ...
        _clearPasswordFields: function () {
            if (this._oChangePasswordDialog) {
                var aItems = this._oChangePasswordDialog.getContent()[0].getItems();
