...
try:
    ...
    # Fallback stubs
    def init_telemetry(*args, **kwargs): return True
    def trace_async(span_name):
        def decorator(func):
            return func
        return decorator
    def add_span_attributes(**kwargs): pass
...
try:
    ...
    def get_handler_metadata(*args): return {}
...
class A2AAgentBase(ABC):
    ...
    def __init__(
        ...
        if enable_telemetry and telemetry_config.otel_enabled:
            init_telemetry(
