...
class AIEnhancer:
    """
    AI Enhancement Service for ORD Registry
...
def create_ai_enhancer(grok_client: GrokClient = None, perplexity_client: PerplexityClient = None) -> AIEnhancer:
    """Create an AI enhancer with the provided clients"""
    return AIEnhancer(grok_client=grok_client, perplexity_client=perplexity_client)
