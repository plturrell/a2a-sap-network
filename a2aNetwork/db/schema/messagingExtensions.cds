 ...
 */
service MessagePersistenceService @(path: '/api/v1/messaging/persistence') {
...
service DeadLetterQueueService @(path: '/api/v1/messaging/dlq') {
...
service MessageTransformationService @(path: '/api/v1/messaging/transform') {
