sap.ui.define([
    ...
    return {
         ...
         */
        generateMetadataSchema(properties) {
         ...
         */
        exportCatalogData(entries, format) {
            if (!entries || !Array.isArray(entries)) {return "";}
         ...
         */
        generateCatalogStatistics(entries) {
            if (!entries || !Array.isArray(entries)) {return {};}
