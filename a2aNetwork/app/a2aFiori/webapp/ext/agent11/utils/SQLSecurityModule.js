sap.ui.define([
    ...
    return {
         ...
         */
        createParameterizedQuery: function(template, parameters) {
         ...
         */
        sanitizeParameter: function(value) {
         ...
         */
        buildSelectQuery: function(options) {
         ...
         * @returns {object} Parameterized query
         */
        buildInsertQuery: function(options) {
            const table = this.validateIdentifier(options.table);
         ...
         * @returns {object} Parameterized query
         */
        buildUpdateQuery: function(options) {
            const table = this.validateIdentifier(options.table);
            const data = options.data || {};
            const conditions = options.where || {};
         ...
         * @returns {object} Parameterized query
         */
        buildDeleteQuery: function(options) {
            const table = this.validateIdentifier(options.table);
            const conditions = options.where || {};
         ...
         * @private
         */
        _buildWhereClause: function(conditions, parameters) {
            const clauses = [];
         ...
         * @private
         */
        _validateOperator: function(operator) {
         ...
         */
        executeQuery: function(parameterizedQuery) {
