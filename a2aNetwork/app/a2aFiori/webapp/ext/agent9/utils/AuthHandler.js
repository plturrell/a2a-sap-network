    ...
    var AuthHandler = {
        ...
        hasPermission: function(permission) {
            try {
                ...
                var requiredRoles = permissionMap[permission];
                if (!requiredRoles) {
        ...
        hasRole: function(role) {
            try {
                ...
                var userRoles = user.sapRoles || user.roles || [];
         ...
         */
        validateReasoningAccess: function(operation, context) {
            var result = { isValid: false, reason: 'Access denied' };
