sap.ui.define([
    ...
    return {
        ...
        validateDublinCore(dublinCoreData) {
            if (!dublinCoreData) {
        ...
        validateLineageData(lineageData) {
            if (!lineageData) {
        ...
        secureCallFunction(model, functionName, parameters, successCallback, errorCallback) {
        ...
        _executeSecureCall(model, functionName, parameters, successCallback, errorCallback) {
            try {
        ...
        validateExportData(data, includePrivate) {
