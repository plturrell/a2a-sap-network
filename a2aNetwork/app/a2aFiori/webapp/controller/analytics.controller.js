sap.ui.define([
    ...
    return Controller.extend("a2a.network.fiori.controller.Analytics", {
        ...
        _initializeChartData: function() {
            ...
            var oTrendModel = new sap.ui.model.json.JSONModel(trendData);
            ...
            var oCategoryModel = new sap.ui.model.json.JSONModel(categoryData);
            this.byId("serviceCategoryChart").setModel(oCategoryModel);
        },

        _updateCharts: function() {
            // Refresh chart data
            var oVizFrame = this.byId("agentTrendChart");
            oVizFrame.getVizProperties().title.text = "Agent Activity - Last 30 Days";
            
            var oCategoryChart = this.byId("serviceCategoryChart");
