/**
 * @fileoverview SAP User Management Service
 * @description Enterprise user service providing authentication, user information management,
 * BTP integration, role-based access control, and multi-tenant user context handling.
