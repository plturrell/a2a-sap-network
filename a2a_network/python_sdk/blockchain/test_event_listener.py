...
async def test_event_listener():
    ...
    try:
        # Import components
        from a2a.blockchain.event_listener import MessageEventListener, BlockchainMessage
        from a2a.blockchain.web3_client import get_blockchain_client
...
async def test_agent_integration():
    ...
    try:
        from a2a.blockchain.agent_integration import BlockchainAgentIntegration, AgentCapability
