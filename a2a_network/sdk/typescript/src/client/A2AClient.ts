...
import { A2AClientConfig, NetworkConfig, ConnectionState } from '../types/Common';
import { A2AError, ErrorCode } from '../utils/errors';
import { validateAddress, validateConfig } from '../utils/validation';
...
export class A2AClient extends EventEmitter {
     ...
     */
    async subscribe(contractName: string, eventName: string, callback: (...args: any[]) => void): Promise<string> {
