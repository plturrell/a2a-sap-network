...
class DataStandardizationAgent(A2AAgentBase):
    ...
    async def _initialize_trust_identity(self) -> None:
        ...
        try:
            ...
            logger.info("Trust identity initialized for Data Standardization Agent")
        ...
        try:
            ...
            for data_type, data in request.items():
                if data_type in self.standardizers:
                    logger.info("Standardizing %d %s records", len(data), data_type)
            ...
            logger.error("Error processing standardization: %s", e)
    ...
    async def _send_to_downstream(self, data: Dict[str, Any], context_id: str):
        ...
        try:
            ...
            logger.info("Sent standardized data to downstream agent at %s",
