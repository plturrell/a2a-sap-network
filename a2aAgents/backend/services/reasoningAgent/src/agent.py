...
class ReasoningAgent(A2AAgentBase):
    ...
    async def _initialize_trust_identity(self) -> None:
        ...
        try:
            ...
            logger.info("Trust identity initialized for Reasoning Agent")
    ...
    async def shutdown(self) -> None:
        ...
        # Cancel any active reasoning tasks
        if hasattr(self, 'active_reasoning_tasks'):
            for task_id in list(self.active_reasoning_tasks.keys()):
