...
try:
    ...
    from embeddingFinetuner import EmbeddingFineTuner, TrainingPair
    
    # Define FineTuningConfig locally if not available
    @dataclass
...
class EmbeddingFineTunerAgent(A2AAgentBase):
    ...
    async def register_with_network(self) -> None:
        ...
        try:
            ...
            logger.info(f"Capabilities: model_fine_tuning, embedding_training, contrastive_learning")
