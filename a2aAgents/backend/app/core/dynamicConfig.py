    ...
    def __post_init__(self):
        ...
        try:
            ...
            if not parsed.scheme:
                raise ConfigValidationError("Invalid DATABASE_URL format: missing scheme")
            # SQLite URLs don't have hostname, they use file paths
            if parsed.scheme not in ['sqlite', 'sqlite+aiosqlite'] and not parsed.hostname:
                raise ConfigValidationError("Invalid DATABASE_URL format: missing hostname")
...
class DynamicConfigManager:
    ...
    def _load_from_environment(self):
        ...
        default_db_url = 'sqlite:///./data/a2a_agents.db'
