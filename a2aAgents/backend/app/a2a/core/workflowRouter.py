...
# Add a2aNetwork to Python path for absolute imports
a2a_network_path = os.path.abspath(os.path.join(os.path.dirname(__file__), '../../../a2aNetwork'))
if a2a_network_path not in sys.path:
    sys.path.insert(0, a2a_network_path)

# Import without fallbacks - let it fail if services are missing
