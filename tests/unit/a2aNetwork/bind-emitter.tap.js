...
test('event emitters bound to CLS context', (t) => {
  t.plan(13);

  t.test('handler registered in context, emit out of context', (t) => {
    t.plan(1);
  ...
  t.test('once handler registered in context', (t) => {
    t.plan(1);
  ...
  t.test('handler registered out of context, emit in context', (t) => {
    t.plan(1);
  ...
  t.test('once handler registered out of context', (t) => {
    t.plan(1);
  ...
  t.test('handler registered out of context, emit out of context', (t) => {
    t.plan(1);
  ...
  t.test('once handler registered out of context on Readable', (t) => {
  ...
  t.test('emitter with newListener that removes handler', (t) => {
    t.plan(3);
  ...
  t.test('handler registered in context on Readable', (t) => {
    const Readable = require('stream').Readable;
  ...
  t.test('handler added but used entirely out of context', (t) => {
    t.plan(2);
  ...
  t.test('handler added but no listeners registered', (t) => {
    t.plan(3);
  ...
  t.test('listener with parameters added but not bound to context', (t) => {
    t.plan(2);
  ...
  t.test('listener that throws doesn\'t leave removeListener wrapped', (t) => {
    t.plan(4);
  ...
  t.test('emitter bound to multiple namespaces handles them correctly', (t) => {
    t.plan(8);
    ...
    t.doesNotThrow(() => { ns1.bindEmitter(ee); });
    t.doesNotThrow(() => { ns2.bindEmitter(ee); });
