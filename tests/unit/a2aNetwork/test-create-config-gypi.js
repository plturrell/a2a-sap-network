...
test('config.gypi with no options', async (t) => {
  t.plan(2);
...
test('config.gypi with --debug', async (t) => {
  t.plan(1);
...
test('config.gypi with custom options', async (t) => {
  t.plan(1);
...
test('config.gypi with nodedir', async (t) => {
  t.plan(1);
...
test('config.gypi with --force-process-config', async (t) => {
  t.plan(1);
