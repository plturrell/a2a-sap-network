...
class Agent0ToAgent1WorkflowTester:
    ...
    def __init__(self):
        ...
        self.ordRegistry_url = f"{self.base_url}/api/v1/ord"
    ...
    def run_complete_test_suite(self):
        ...
        try:
            ...
            self.test_ordRegistry_integration()
    ...
    def test_environment_setup(self):
        ...
        # Check ORD Registry
        try:
            response = requests.get(f"{self.ordRegistry_url}/health", timeout=5)
            if response.status_code == 200:
                results["ordRegistry"] = {"status": "healthy", "response": response.json()}
                print("✅ ORD Registry is healthy")
            else:
                results["ordRegistry"] = {"status": "unhealthy", "code": response.status_code}
                print(f"❌ ORD Registry unhealthy: {response.status_code}")
        except Exception as e:
            results["ordRegistry"] = {"status": "error", "error": str(e)}
    ...
    def test_ordRegistry_integration(self):
        """Test 4: ORD Registry Integration"""
        ...
        try:
            ...
            response = requests.post(f"{self.ordRegistry_url}/search", json=search_request, timeout=10)
        ...
        self.test_results["test_sections"]["ordRegistry"] = results
        print()
                ...
                "message": {
                    ...
                    "parts": [
                        ...
                        },
                        {
                            ...
                            "data": {
                                "ord_reference": {
                                    "registry_url": self.ordRegistry_url,
                                    "resource_type": "dataProduct",
                                    "query_params": {
                                        "tags": ["crd", "raw-data"]
                                    }
