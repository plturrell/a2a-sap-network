...
# Import SDK components from a2aNetwork (preferred) or fallback to local
try:
    import sys
    sys.path.insert(0, '/Users/apple/projects/a2a/a2aNetwork')
    from sdk.types import A2AMessage, MessagePart, MessageRole
    from sdk.types import TaskStatus, AgentCard
    ...
    from app.a2a.sdk.types import TaskStatus, AgentCard
    print("⚠️  Using local SDK components (fallback)")
