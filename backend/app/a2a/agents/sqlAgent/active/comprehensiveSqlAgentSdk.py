...
if HTTPX_AVAILABLE:
    GrokSQLClient = RealGrokSQLClient
else:
    class MockGrokSQLClient:
        def __init__(self):
            self.available = False
        async def convert_nl_to_sql(self, nl: str, schema: str = ""):
            return {'success': False, 'message': 'Grok client unavailable'}
        async def optimize_sql_query(self, sql: str, context: str = ""):
            return {'success': False, 'message': 'Grok client unavailable'}
