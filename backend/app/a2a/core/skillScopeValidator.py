...
from ..security.delegationContracts import get_delegation_contract, DelegationAction
...
class TrustBasedHelpValidator:
    ...
    def __init__(self):
        ...
        self.skill_categories = {
            ...
            "data_processing": {
                ...
                "cds-csn-generation",
                "ord-descriptor-creation-with-dublin-core",
                "catalog-registration-enhanced",
            ...
            "infrastructure": {"smart-delegation", "a2a-orchestration", "ai-advisor"},
        }
        ...
        try:
            ...
            if help_type == HelpRequestType.SKILL_GUIDANCE:
                ...
                return self._validate_status_inquiry(
                    requesting_agent_id, target_agent_id, requester_skills, target_skills
                )
    ...
    def _validate_skill_guidance(
        ...
        if not requested_skill:
            return {
                ...
                "allowed_help_types": [
                    HelpRequestType.STATUS_INQUIRY.value,
                    HelpRequestType.CAPABILITY_QUESTION.value,
                ],
                "skill_compatibility": {"requester_has_skill": False, "target_has_skill": False},
            }
        ...
        delegation_valid = self._check_delegation_authority(
            requesting_agent_id, target_agent_id, requested_skill
        )
    ...
    def _validate_status_inquiry(
        ...
        return {
            ...
            "skill_compatibility": {"inquiry_type": "status_report", "delegation_required": False},
        }
    ...
    def _check_delegation_authority(
        self, requesting_agent_id: str, target_agent_id: str, skill: str
    ) -> bool:
        ...
        try:
            ...
            for delegation_rule in self.delegation_contract.delegation_rules.values():
                if (
                    delegation_rule.delegator_id == requesting_agent_id
                    and delegation_rule.delegatee_id == target_agent_id
                    and delegation_rule.is_valid()
                ):
    ...
    def get_allowed_help_requests(
        ...
        return {
            ...
            "agent_skills": {"requester": list(requester_skills), "target": list(target_skills)},
        }
