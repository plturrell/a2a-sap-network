...
class PerformanceAlert:
    ...
    def __init__(self, alert_type: str, severity: str, message: str, 
                 value: float, threshold: float, agent_id: str):
...
class PerformanceMonitor:
    ...
    def record_request(self, method: str = "unknown", duration: float = 0.0, 
                      success: bool = True, status: str = "200"):
...
def create_performance_monitor(agent_id: str, 
                              alert_thresholds: Optional[AlertThresholds] = None,
                              metrics_port: int = None) -> PerformanceMonitor:
