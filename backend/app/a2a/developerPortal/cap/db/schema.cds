...
entity Users : cuid, managed {
  ...
  email           : String(320) @title: 'Email Address';
  ...
  // Security attributes
  securityClearance    : String(20) @title: 'Security Clearance Level';
  dataClassification   : String(20) @title: 'Data Classification Access';
  s4hanaSystemAccess   : String(500) @title: 'SAP S/4HANA System Access';
...
entity WorkflowTemplates : cuid, managed {
  ...
  processKey      : String(100) @title: 'Process Key';
...
entity WorkflowExecutions : cuid, managed {
  ...
  correlationId   : String(100) @title: 'Correlation ID';
  businessKey     : String(100) @title: 'Business Key';
...
entity SystemConnections : cuid, managed {
  ...
  authType        : String(50) @title: 'Authentication Type';
  connectionParams : LargeString @title: 'Connection Parameters (Encrypted JSON)';
