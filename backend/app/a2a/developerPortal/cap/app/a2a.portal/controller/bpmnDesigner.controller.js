    ...
    return Controller.extend("a2a.portal.controller.BPMNDesigner", {
        ...
        _saveUndoState: function () {
            ...
            this._undoStack.push({
                elements: JSON.parse(JSON.stringify(this._workflowModel.elements)),
                connections: JSON.parse(JSON.stringify(this._workflowModel.connections))
            });
        ...
        onZoomIn: function () {
            ...
            var iZoom = oModel.getProperty("/zoomLevel");
        ...
        onToggleGrid: function () {
            var oModel = this.getView().getModel();
            var bGrid = !oModel.getProperty("/gridEnabled");
        ...
        onValidateWorkflow: function () {
            ...
            // Simple validation
            var bHasStart = this._workflowModel.elements.some(function (el) {
                return el.type === "StartEvent";
            });
            var bHasEnd = this._workflowModel.elements.some(function (el) {
        ...
        onDeleteElement: function () {
            var oModel = this.getView().getModel();
            var oSelected = oModel.getProperty("/selectedElement");
                ...
                MessageBox.confirm("Delete element '" + oSelected.name + "'?", {
                    onClose: function (sAction) {
                        if (sAction === MessageBox.Action.OK) {
                            ...
                            var iIndex = this._workflowModel.elements.findIndex(function (el) {
...
<bpmn:definitions xmlns:bpmn="http://www.omg.org/spec/BPMN/20100524/MODEL" 
    ...
    <bpmn:process id="Process_1" isExecutable="true">
        ${this._workflowModel.elements.map(function (el) {
        ...
        _saveWorkflow: function (bDraft) {
            var oModel = this.getView().getModel();
            var sWorkflowName = oModel.getProperty("/workflowName");
