...
class BusinessPartnerService {
    ...
    async updateBusinessPartner(businessPartnerId, updateData) {
        try {
            ...
            // Update fields
            if (updateData.firstName) existingBP.firstName = updateData.firstName;
            if (updateData.lastName) existingBP.lastName = updateData.lastName;
            if (updateData.organizationName) existingBP.organizationBpName1 = updateData.organizationName;
