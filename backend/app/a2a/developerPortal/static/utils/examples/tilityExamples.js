...
sap.ui.define([
    ...
    "sap/m/MessageBox",
    "sap/m/MessageToast"
], function (Controller, GuidedTourManager, HelpProvider, NotificationService, MessageBox, MessageToast) {
    "use strict";
    ...
    return Controller.extend("a2a.portal.utils.examples.UtilityExamples", {
        ...
        startOnboardingTour: function() {
            ...
            tourManager.startTour(onboardingTour, this.getView(), function() {
        ...
        startAgentCreationTour: function() {
            ...
            tourManager.startTour(agentTour, this.getView(), function() {
        ...
        _startTourWithProgress: function(tourManager, tour) {
            ...
            tourManager.startTour(tour, this.getView(), function() {
