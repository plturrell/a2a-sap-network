sap.ui.define([
    ...
    return Controller.extend("a2a.portal.controller.Deployment", {
        ...
        _loadDeploymentData: function () {
            ...
            jQuery.ajax({
                ...
                error: function (xhr, status, error) {
                    ...
                    var oMockData = this._getMockDeploymentData();
        ...
        onSearch: function (oEvent) {
            ...
            var sViewMode = this.getView().getModel("view").getProperty("/viewMode");
            var oTable, oBinding;
        ...
        onEnvironmentPress: function (oEvent) {
            ...
            var sEnvironmentId = oContext.getProperty("id");
        ...
        onManageEnvironment: function (oEvent) {
            ...
            var oContext = oEvent.getSource().getBindingContext("view");
            var sEnvName = oContext.getProperty("name");
        ...
        onDeleteEnvironment: function (oEvent) {
            ...
            var oContext = oEvent.getSource().getBindingContext("view");
            var sEnvName = oContext.getProperty("name");
            var sEnvId = oContext.getProperty("id");
        ...
        onPipelinePress: function (oEvent) {
            var oContext = oEvent.getSource().getBindingContext("view");
            var sPipelineId = oContext.getProperty("id");
        ...
        onRunPipeline: function (oEvent) {
            oEvent.stopPropagation();
            var oContext = oEvent.getSource().getBindingContext("view");
            var sPipelineName = oContext.getProperty("name");
        ...
        onReleasePress: function (oEvent) {
            var oContext = oEvent.getSource().getBindingContext("view");
            var sReleaseId = oContext.getProperty("id");
        ...
        onDeployRelease: function (oEvent) {
            oEvent.stopPropagation();
            var oContext = oEvent.getSource().getBindingContext("view");
            var sVersion = oContext.getProperty("version");
