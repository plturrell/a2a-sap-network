sap.ui.define([
...
], function (BaseController, MessageToast, MessageBox, JSONModel, Fragment, DateFormat, OfflineManager) {
    "use strict";
    ...
    return BaseController.extend("sap.a2a.controller.ConflictResolutionController", {
        ...
        _setupFormatters: function () {
            ...
            this.formatConflictsTableTitle = function (aConflicts, sTemplate) {
         ...
         */
        _openManualMergeDialog: function (oConflict) {
