sap.ui.define([
    ...
    return Controller.extend("sap.a2a.controller.BaseController", {
         ...
         */
        _onNetworkOnline: function (oEventData) {
            this._updateOfflineStatus();
         ...
         * @param {object} oEventData event data
         */
        _onNetworkOffline: function (oEventData) {
            this._updateOfflineStatus();
         ...
         * @param {object} oEventData event data
         */
        _onSyncComplete: function (oEventData) {
            this._updateOfflineStatus();
         ...
         */
        formatOfflineMessage: function (iPendingChanges, sMessageWithChanges, sMessageWithoutChanges) {
         ...
         */
        formatPendingChanges: function (iCount, sTemplate) {
         ...
         */
        formatConflicts: function (iCount, sTemplate) {
         ...
         */
        formatLastSync: function (oLastSync, sTemplate) {
            if (!oLastSync) return this.getResourceBundle().getText("offline.neverSynced");
        ...
        _openSyncQueueDialog: function (aSyncQueue) {
            const oSyncQueueModel = new sap.ui.model.json.JSONModel({
