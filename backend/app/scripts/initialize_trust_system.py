...
logging.basicConfig(
    ...
    handlers=[
        ...
        logging.FileHandler('/tmp/trust_initialization.log')
    ]
)
...
async def generate_initialization_report(results, trust_initializer):
    ...
    try:
        ...
        # Save report
        report_file = Path("/tmp") / "a2a_trust_initialization_report.json"
...
async def cleanup_test_data():
    ...
    try:
        ...
        trust_storage_path = os.getenv("TRUST_STORAGE_PATH", "/tmp/a2a_trust_identities")
        test_files = [
