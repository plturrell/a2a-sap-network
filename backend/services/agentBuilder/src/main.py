#!/usr/bin/env python3
"""
Agent Builder - A2A Microservice
Creates and manages agent templates and configurations
"""
...
async def main():
    ...
    port = int(os.getenv("A2A_AGENT_PORT", "8014"))
    ...
    async def health():
        return {
            ...
            "version": agent.version,
            "a2a_protocol": "0.2.9",
            "templates_loaded": len(getattr(agent, 'agent_templates', {}))
        }
